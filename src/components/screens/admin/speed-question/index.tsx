...
import speedQuestionImg from '@/assets/images/speed_question.png'
import logo from '@/assets/images/Sobi-Fantasy-Game-Logo.webp'
import person from '@/assets/images/person.png'
import Image from 'next/image'

export default function SpeedQuestion() {
    return (
        <div
